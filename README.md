...
### Grading: This task is graded on both the number of problems solved and the quality of your code, with quality weighted slightly higher. A clean, well-written solution to three problems will score better than messy solutions to five. 
